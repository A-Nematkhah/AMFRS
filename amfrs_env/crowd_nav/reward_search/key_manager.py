...
Loads keys from ``amfrs_env/groq_keys.json`` (or ``GROQ_KEYS_PATH``).
...
_AMFRS_ROOT = os.path.abspath(os.path.join(os.path.dirname(__file__), "..", ".."))
DEFAULT_GROQ_KEYS_PATH = os.path.join(_AMFRS_ROOT, "groq_keys.json")
