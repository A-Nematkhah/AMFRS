#!/usr/bin/env python
"""
Plot AMFRS Algorithm 1 metrics from a run directory (offline, no GPU).
...
Examples::
    ...
    python scripts/plot_amfrs_run.py --run-dir results/run_1to2h
    python scripts/plot_amfrs_run.py --run-dir results/run_easy --show
"""
...
def main() -> int:
    parser = argparse.ArgumentParser(description="Plot AMFRS run metrics to PNG")
