#!/usr/bin/env python
"""
Human-triggered paper-scale AMFRS run (Tables 3–6 budgets).
...
Examples::
    ...
    python scripts/run_amfrs_paper_scale.py --seeds 425,426,427 --device cuda
    python scripts/run_amfrs_paper_scale.py --dry-run-stubs  # wiring only
"""
...
def main() -> int:
    ...
    parser = argparse.ArgumentParser(
        description="AMFRS paper-scale multi-seed Algorithm 1 (Tables 3–6)"
    )
    parser.add_argument(
        "--config",
        type=str,
